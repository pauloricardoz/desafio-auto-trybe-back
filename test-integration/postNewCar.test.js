...
describe('PostNewCar', function () {
  describe('Fail cases', function () {
    ...
    Object.entries(testData.newCar).forEach(([key, value]) => {
      describe(`Post New Car ${key} ${value} `, checkProperties(key, value));
    });
  });
    ...
    function checkProperties() {
      return function () {
        ...
        it('Object inside array contain all basic properties', function () {
          expect(response.body).to.contains.keys([...Object.keys(testData.newCar), 'id']);
        });
      };
    }
      describe('Post New Car ', checkProperties());
  });
});
